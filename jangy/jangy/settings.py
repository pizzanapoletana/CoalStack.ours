"""
Django settings for jangy project.
...
SECRET_KEY = 'django-insecure-1cl1k-m@g_wpy&=-4@uo%5d^s#bb+d(^^qlmzr*6c)!zt8j+x8'
...
WSGI_APPLICATION = 'jangy.wsgi.application'
